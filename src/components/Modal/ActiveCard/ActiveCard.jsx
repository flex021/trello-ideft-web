...
function ActiveCard() {
  ...
  const handleDeleteCard = () => {
    confirmDeleteColumn({
      ...
      const targetColumn = newBoard.columns.find(col => col.cards.some(c => c._id === activeCard._id))
      if (targetColumn) {
      ...
      <Box sx={{
        ...
        <Grid container spacing={2} sx={{ mb: 3 }}>
          ...
          <Grid xs={12} sm={3}>
            ...
            <Stack direction="column" spacing={1}>
              <SidebarItem onClick={handleDeleteCard}><ArrowForwardOutlinedIcon fontSize="small" />Delete</SidebarItem>
